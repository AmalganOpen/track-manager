...
test_urls = [
    ...
    (
        "https://www.youtube.com/watch?v=mgomHKRTlVc&list=PLdo7RntGOYQeqbdSB07bu1tOU05HWFZS9&index=1",
        "video_in_playlist",
        "mgomHKRTlVc",
        "PLdo7RntGOYQeqbdSB07bu1tOU05HWFZS9",
    ),
    (
        "https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLtest123&index=5",
        "video_in_playlist",
        "dQw4w9WgXcQ",
        "PLtest123",
    ),
    ...
    (
        "https://music.youtube.com/playlist?list=RDCLAK5uy_test123",
        "playlist",
        None,
        "RDCLAK5uy_test123",
    ),
    (
        "https://music.youtube.com/playlist?list=PLtest456",
        "playlist",
        None,
        "PLtest456",
    ),
    ...
    (
        "https://music.youtube.com/watch?v=xyz789&list=RDCLAK5uy_test&index=3",
        "video_in_playlist",
        "xyz789",
        "RDCLAK5uy_test",
    ),
...
for url, expected_type, expected_video_id, expected_playlist_id in test_urls:
    ...
    passed = (
        ...
        and video_id == expected_video_id
        and playlist_id == expected_playlist_id
    )
    ...
    print(f"URL: {url}")
    print(
        f"Expected: type={expected_type}, video_id={expected_video_id}, playlist_id={expected_playlist_id}"
    )
